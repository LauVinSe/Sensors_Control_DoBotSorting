function [highlighted_img,centroids, g] = detect_green(img)
    ...
    hue_lower_threshold = 0.2;    % Adjust as needed
    hue_upper_threshold = 0.5;    % Adjust as needed
    saturation_threshold = 0.9;    % Adjust as needed
    value_threshold = 0.01;         % Adjust as needed
